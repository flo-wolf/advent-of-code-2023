...
class Game:
    ...
    def calc_max_color_occurences(self) -> bool:
        self.max_red = 0
        self.max_green = 0
        self.max_blue = 0
...
for line in lines:
    game = Game(line)
    game.calc_max_color_occurences()
    cubed_colors = game.max_red * game.max_blue * game.max_green
    cubed_colors_sum += cubed_colors

print(cubed_colors_sum)